...
const LoginPage = () => {
  ...
  const validateForm = () => {
    ...
    } else if (!securityMiddleware.validateEmail(formData.email)) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await securityMiddleware.authenticate({
        ...
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-900">PaperMorph</span>
            </div>
          </div>
